...
Everything else (retention days, reverse DNS, ASN lookup, notification channels, public URL, tag colours, the Globalping token, the ip-api.com switch, the MaxMind credentials) is set in the UI under **Settings** and stored in the database.
